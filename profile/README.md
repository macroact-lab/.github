...
---
### 📖 도서 및 로봇 구매
[![교보문고](https://img.shields.io/badge/교보문고-5E9025?style=for-the-badge&logoColor=white)](https://search.kyobobook.co.kr/search?keyword=S000219337992)
...
[![학교장터](https://img.shields.io/badge/학교장터_(S2B)-ED7200?style=for-the-badge&logoColor=white)](https://www.s2b.kr/S2BNCustomer/rema100No.do?forwardName=detail&f_re_estimate_code=202410209736152)

### 📚 주요 교재 및 프로젝트
*   **[실용 로봇공학]** : ROS2와 강화학습으로 완성하는 적응형 로봇 (2026 출간)
*   **[웹 시뮬레이터]** : 설치 없이 브라우저에서 실행하는 로봇 제어 환경
*   **[마이캣 제어 웹]** : 마이캣을 위한 블록코딩 및 ROS2 자바스크립트 프로그램
...
3. [에듀테크 스튜디오(Coming soon)](https://studio.macroact.com)
...
---
*주식회사 매크로액트는 인간과 로봇이 공존하는 미래를 설계합니다.*
